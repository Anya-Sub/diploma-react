  ...
  return (  
    ...
    <main>
      <section className="label-info">
        ...
        <img src={Line} alt="Line" className="label-info__image__two"></img>
      </section>
    </main>
    <Footer />
    </> 
